...
export default function cursorAnimation() {
    if (globalThis.window != undefined) {
        if ($("body").not(".is-mobile").hasClass("tp-magic-cursor")) {
            ...
            const $ballWidth = 14; // Ball default width
            const $ballHeight = 14; // Ball default height
            const $ballScale = 1; // Ball default scale
            const $ballOpacity = 1; // Ball default opacity
            const $ballBorderWidth = 1; // Ball default border width
