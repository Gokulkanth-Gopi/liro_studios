...
const BrandingFlipbook = () => {
  ...
  const sheets = useMemo(() => [
    { id: "branding-sheet-1", front: insta1, back: insta2 },
    { id: "branding-sheet-2", front: insta3, back: insta4 },
    { id: "branding-sheet-3", front: insta5, back: insta6 },
  ], []);
...
export default BrandingFlipbook;
