...
const ImageTrail: React.FC<ImageTrailProps> = ({ images }) => {
  ...
  useEffect(() => {
    ...
    globalThis.addEventListener('touchmove', handlePointerMove as EventListener, { passive: false });
    ...
    const onPointerMoveEv = () => {
      ...
      globalThis.removeEventListener('mousemove', onPointerMoveEv);
    };

    globalThis.addEventListener('mousemove', onPointerMoveEv);

    return () => {
      globalThis.removeEventListener('mousemove', handlePointerMove);
      globalThis.removeEventListener('touchmove', handlePointerMove as EventListener);
